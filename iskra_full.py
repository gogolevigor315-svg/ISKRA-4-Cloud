#!/usr/bin/env python3
# =============================================================================
# ISKRA-4 CLOUD v10.10 — FINAL ORCHESTRATOR (Исправлено для Flask 2.3+)
# =============================================================================
import os
import sys
import asyncio
...
# =============================================================================
# ЗАПУСК ФОНОВЫХ ЗАДАЧ (правильный способ для Flask 2.3+)
# =============================================================================
@app.before_serving
async def startup():
    """Запуск при старте сервера (совместимо с Flask 2.3+)"""
